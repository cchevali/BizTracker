...
} from "./researched-listings-2026-04-23-requested.data";
import {
...
export type ResearchedListing20260423RequestedUpsertSummary = {
  createdNames: string[];
  updatedNames: string[];
};
        ...
        create: [
          {
            ...
            description: "Added from the 2026-04-23 requested researched listing batch.",
            metadata: {
  ...
  const historyEvents: Prisma.BusinessHistoryEventCreateWithoutBusinessInput[] = [
    {
      ...
      description: "Updated fields from the 2026-04-23 requested researched listing batch.",
      metadata: {
        batchDate: RESEARCHED_LISTING_BATCH_DATE,
        sourceUrl: seed.sourceUrl,
        changedFields,
...
export async function upsertResearchedListingBatch20260423Requested(
  prisma: PrismaClient,
): Promise<ResearchedListing20260423RequestedUpsertSummary> {
