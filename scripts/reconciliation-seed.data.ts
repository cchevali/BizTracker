import { DealStatus } from "../src/generated/prisma/enums";

export type ReconciliationSeedBusiness = {
  businessName: string;
  sourceUrl: string;
  category: string;
  subcategory: string;
...
export const reconciliationSeedBusinesses: ReconciliationSeedBusiness[] = [
  {
