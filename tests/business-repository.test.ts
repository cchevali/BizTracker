...
function createBusinessInput(
  ...
  return {
    ...
    benchmarkNotes: "Beats the current route benchmark on recurring revenue and lower capital needs.",
    financeabilityRating: 4,
    sellerFinancingAvailable: true,
    sellerFinancingNotes: "Seller seems open to a small note.",
    ...
    freshnessVerifiedAt: new Date("2026-04-06T12:00:00.000Z"),
    cashToCloseNotes: "Could come in a little higher if working capital needs are real.",
    overallScore: 82,
...
function createExistingBusiness(overrides: Record<string, unknown> = {}) {
  return {
    ...
    beatsCurrentBenchmark: true,
    benchmarkNotes:
      "Beats the current route benchmark on recurring revenue and lower capital needs.",
    financeabilityRating: 4,
    sellerFinancingAvailable: true,
    sellerFinancingNotes: "Seller seems open to a small note.",
    operatorSkillDependency: 2,
    ...
    keyPersonRisk: 3,
    homeBasedFlag: true,
    recurringRevenuePercent: new Prisma.Decimal(88),
    ownerHoursClaimed: 35,
    opsManagerExists: false,
    freshnessVerifiedAt: new Date("2026-04-06T12:00:00.000Z"),
    cashToCloseNotes: "Could come in a little higher if working capital needs are real.",
